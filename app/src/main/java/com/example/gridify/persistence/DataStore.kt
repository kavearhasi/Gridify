...
import com.example.gridify.GameSettings
import com.example.gridify.Statistics
...
internal val Context.settingsDatastore: DataStore<GameSettings> by dataStore(
    ...
    serializer = GameSettingSerializer
)

object GameSettingSerializer :
    Serializer<GameSettings> {
